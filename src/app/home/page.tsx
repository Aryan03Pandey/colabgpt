    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <header className="relative h-screen overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-4 lg:px-12">
          ...
          >
            <a href="#" className="hover:text-gray-300 transition font-lato">Recipes</a>
            <a href="#" className="hover:text-gray-300 transition font-lato">Categories</a>
            <a href="#" className="hover:text-gray-300 transition font-lato">About</a>
            <a href="#" className="hover:text-gray-300 transition font-lato">Contact</a>
          </motion.div>
        </nav>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          ...
          >
            Join our community of passionate food lovers and share your unique recipes with the world
          </motion.p>
      ...
      <section ref={recipeRef} className="py-20 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-playfair">Discover New Flavors Every Day</h2>
            <p className="text-gray-600 mb-8 text-lg font-lato">
              From traditional classics to modern fusion, explore recipes that will inspire your next culinary adventure.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
      ...
      <section ref={recipeRef} className="py-20 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-playfair">Indulge in Exquisite Desserts</h2>
            <p className="text-gray-600 mb-8 text-lg font-lato">
              Satisfy your sweet tooth with our handpicked dessert recipes, from rich cakes to refreshing ice creams.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
      ...
      <section ref={recipeRef} className="py-20 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-playfair">Healthy & Wholesome Meals</h2>
            <p className="text-gray-600 mb-8 text-lg font-lato">
              Enjoy delicious, nutritious recipes that fuel your body and support a balanced lifestyle.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
